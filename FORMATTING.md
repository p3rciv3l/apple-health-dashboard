...
- Straus Family Creamery Organic Cream-Top Whole Milk (large red-cap bottle): per 1 cup (240mL) = 160 kcal, 9g protein, 11g carb, 9g fat (7g sat), 11g sugar, 0g fiber, 75mg sodium (manufacturer label, 2026-08-23). The 2026-08-22 Straus glass was logged at 2%-equivalent on purpose, to avoid double-counting the cream cap logged as its own row - that is a one-off exception, not this anchor.
